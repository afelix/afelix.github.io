...
Проблема возникает при чтении сканов (**PDF/DjVu**). Проще на ярком примере. Посмотрите на журнал вроде *«Популярная механика»*, цитирую размер из их же требований к рекламному блоку: *«Формат журнала в готовом виде 205х275 мм»*. А полный размер, например, шестидюймового Kindle Paperwhite (10th gen) с рамками 167х116мм. Рамки там нехилые, потому мысленно сожмите журнал вдвое по длине и вдвое по ширине, получите вот примерно то, что будет перед глазами в читалке. И это ну ни фига не читаемо, слишком мелко. Да, вы можете увеличивать фрагменты страницы, но это вот как дедушке с лупой ползать по атласу мира.

А если не журнал, но скан "просто" книги? Да почти та же фигня, если при обработке после сканирования не обрезали поля страниц впритык к тексту, но и в этом случае размер букв такой, что глаза вытекают уже через десять минут. Словно лапки у муравьёв считаешь, а не слова читаешь. И с издательскими PDF ровно то же, они почти всегда с широкими полями нынче.

По опыту скажу, что 8" — гигиенический минимум для чтения сканов или просто крупного формата. Вам всё равно не будет комфортно, но уже не будет мучительно больно. Правда, чем больше читаешь, тем больше понимаешь, что такое чтение проходит по уровню "терпимо", при этом читалка менее удобна, чем планшет. Я сравнивал Apple iPad mini 5 (7.8") и PocketBook 740 (8"), iPad для сканов в этом размере лучше.
