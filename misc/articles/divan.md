...
Вот то же *«алгоритмы не нужны, всё это фигня»* взять. Не от одного лишь Ромашкина, да и не один раз слышалось такое. А затем ретвиты, репосты... а там уже и радостное эхо выкриков от людей, которых Ромашкины тянут на дно. Всё потому, что Ромашкин понятия не имеет, о чём речь.

**Во-первых**, всем ли людям не нужны алгоритмы? Очевидно, не всем. Берём пример с края: олимпиадникам нужны алгоритмы, они (олимпиадники) ими места занимают. Пример смешной и глупый, но формально уже и он опровергает. Ладно, более реальный: люди, работающие в науке. Они тоже программируют, у них тоже есть алгоритмы. Ладно, предположим, их не бывает или пара человек на планету. Embedded-разработчики реальны. Часто у них задачи вычислительно простые (если не простые, в embedded им не место), но бывают и задачи *«а давайте на паре транзисторов будем считать преобразование Фурье»*, привет, алгоритмы. М... люди, пишущие операционные системы (Ромашкин смеётся, ведь Mac OS давно написан, лол), базы данных, пакеты обработки изображений, редакторы звука, всё такое? Им тоже не нужны алгоритмы?

**Во-вторых**, какие алгоритмы?